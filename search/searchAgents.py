...
class CornersProblem(search.SearchProblem):
    ...
    def getStartState(self):
        ...
        #pozitia lui pacman si informatia legata de cornere
    ...
    def isGoalState(self, state):
        ...
        return True if len(visited_corners) == len(list(self.corners)) else False
        #state = pozitia si info despre corenere, verif daca toate corners  = True
        #util.raiseNotDefined()
...
def cornersHeuristic(state, problem):
    ...
    "*** YOUR CODE HERE ***"
    #return: o valoare numerica care sa ajute astar sa gasesaca corners mai usor
    ...
    while (len(unvisited_corners) != 0):
        distance, corner = min([(manhattanDistance(current_position, corner), corner) for corner in unvisited_corners])
